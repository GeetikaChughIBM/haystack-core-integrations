...
class Db2DocumentStore:
    ...
    def __init__(
        ...
        *,
        ...
        hostname: str,
        port: int = 50000,
        username: Secret = Secret.from_env_var("DB2_USERNAME", strict=False),
        password: Secret = Secret.from_env_var("DB2_PASSWORD", strict=False),
        protocol: str = "TCPIP",
        ...
        :param username: Database username as a `Secret`. Defaults to the `DB2_USERNAME` env var.
        :param password: Database password as a `Secret`. Defaults to the `DB2_PASSWORD` env var.
